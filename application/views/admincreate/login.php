		...
		<header>
			<div class="container-fluit">
				<div class="row">
					<div class="col-lg-4">
						<div class="logo">
							<a href="index.jsp">Create Contents</a>
						</div>
					</div>
		...
		<div class="wrapper fadeInDown">
			<div id="formContent">
				...
				<div class="fadeIn first">
					<em style="font-size:6rem" class="fa fa-user"></em>
                ...
                <?php } ?>
				<!-- Login Form -->
				<form action="<?=base_url()?>admin/authen/login_check" method="post">
